...
Page({
  data: {
    ...
    emotionArr: [],
    messageInputVal: '',
    emotionHost: '../../../images/chat/emotion/',
    nodes: [{
      name: 'img'
    }],
    messageList: [
      {
        ...
        con: '微软开发者大会，请各界技术爱好者参加，欢迎报名' +
          '<img src="../../../images/chat/emotion/Expression_1.png" style="widht:20px;height:20px;vertical-align: middle;"/> 开发者大会',
        avater: '../../../images/chat/avater.jpg'
      },
      {
        type: 'R',
        messageType: 'txt',
        con: "微软开发者大会，请各界技术爱好者参加，欢迎报名",
        avater: '../../../images/chat/pig.jpg'
      }
    ],
    isMedia: false,
    isEmotion: false,
  ...
  onShareAppMessage: function () {
    return {
      ...
      imageUrl: '../../../images/chat/avater.jpg'                      //自定义分享封面
    }
  },
...
function face(obj) {
  let emotion = emotionFun();
  let emotionHost="../../../images/chat/emotion/";
  let face = {};
